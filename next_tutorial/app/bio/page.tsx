    ...
    <div id="defaultTabContent" className="my-[-4px] md:w-[100%] ">
      <img className="w-[50%] m-auto" src="/images/mahdi.jpg"/>
        ...
        <p className="mb-3 text-gray-800 dark:text-black-800">MAHDI ZAMANIAN</p>
            ...
            <a href="https://meytizn.github.io/myprojects/" className="inline-flex items-center font-medium text-blue-600 hover:text-blue-800 dark:text-blue-500 dark:hover:text-blue-700">
                Front-end prjects 
            ...
            <a href="http://zamanianmehdi23blogproject.pythonanywhere.com/#" className="inline-flex items-center font-medium text-blue-600 hover:text-blue-800 dark:text-blue-500 dark:hover:text-blue-700">
            Backend-end prjects 
                <svg className=" w-2.5 h-2.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"></path>
                </svg>
